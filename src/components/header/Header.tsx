...
export function Header({branches, baseDirections}:IHeaderProps) {
      ...
      <div className='header__wrapper'>
        ...
        <nav className='header__nav'>
          <ul className='header__menu'>
            <li>
              <NavLink to='/' className='link popup-open'>
                Продукты
              </NavLink>
                ...
                <ul className="header__popup-menu">
                  {baseDirections.map(direction => !direction.combine &&
                    <li key={direction.id_dir}>
                      <a href={'#'+direction.pageLink} className='link header__popup-link'>{direction.title}</a>
                    </li>
                  )}
                </ul>
              </nav>
            ...
            <li><a href='#Contacts' className='link'>Контакты</a></li>
          </ul>
